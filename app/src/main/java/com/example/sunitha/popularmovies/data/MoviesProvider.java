...
/**
 * Created by Sunitha on 11/25/2015.
 */
            ...
            case MOVIE:
                ...
                try{
                    ...
                    if(numInserted > 0){
                        ...
                        Log.d(LOG_TAG, "bulkInsert::db.setTransactionSuccessful()::numInserted="+ numInserted);
                    }
                } finally {
                ...
                if (numInserted > 0){
                    ...
                    // was a change
                    getContext().getContentResolver().notifyChange(uri, null);
                    Log.d(LOG_TAG, "getContext().getContentResolver().notifyChange(uri, null)");
